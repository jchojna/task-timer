...
const Controls = () => {
  return (
    <div className="Controls">
      <button className="button Controls__button Controls__button--playPause">
      ...
      <button className="button Controls__button Controls__button--stop">
        <svg className="Controls__svg" viewBox="0 0 512 512">
          <use href={`${icons}#stop`} />
        </svg>
      </button>
      <button className="button Controls__button Controls__button--toggle">
        <svg className="Controls__svg" viewBox="0 0 512 512">
